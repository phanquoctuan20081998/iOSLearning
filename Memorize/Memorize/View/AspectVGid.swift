...
//  Memorize
//
//  Created by Phan Quốc Tuấn on 25/07/2021.
//

import SwiftUI

struct AspectVGid<Item, ItemView> : View where ItemView: View, Item: Identifiable {
    var items: [Item]
...
//struct AspectVGid_Previews: PreviewProvider {
